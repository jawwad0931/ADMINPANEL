            ...
            <div class="row">
                <div class="col-sm-3 col-xs-6">
                    <div class="card card-block">
                        <a>
                            <img src="./img/lawyer-1.jpeg" class="law-img" alt="lawyer 1">
                            <div class="card-title-wrap">
                                <span class="card-title"> Sam Mwangi </span>
                                <span class="card-text"> Lawyer </span>
                            </div>
                ...
                <div class="col-sm-3 col-xs-6">
                    <div class="card card-block">
                        <a>
                            <img src="./img/lawyer-2.jpeg" class="law-img" alt="lawyer 2">
                            <div class="card-title-wrap">
                                <span class="card-title"> Joy Kirii </span>
                                <span class="card-text"> Lawyer </span>
                            </div>
                            <div class="lawyer-over">
                                <h4 class="hidden-md-down"> Connect With Me </h4>
                                ...
                                <p>Law is the aggregate set of rules set by a man as politically superior, or sovereign
                                    to men, as political subjects.</p>
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-sm-3 col-xs-6">
                    <div class="card card-block">
                        <a>
                            <img src="./img/lawyer-3.jpeg" class="law-img" alt="lawyer 3">
                            <div class="card-title-wrap">
                                <span class="card-title"> Wairimu Karuga </span>
                                <span class="card-text"> Lawyer </span>
                            </div>
                            <div class="lawyer-over">
                                <h4 class="hidden-md-down"> Connect With Me </h4>
                                ...
                                <p>A set of rules to be followed by everyone, regardless of their stature.</p>
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-sm-3 col-xs-6">
                    <div class="card card-block">
                        <a>
                            <img src="./img/lawyer-4.jpeg" class="law-img" alt="lawyer 4">
                            <div class="card-title-wrap">
                                <span class="card-title"> Hosea </span>
                                <span class="card-text"> Lawyer </span>
                            </div>
                            <div class="lawyer-over">
                                <h4 class="hidden-md-down"> Connect With Me </h4>
                                ...
                                <p>The law does not seek to describe what must occur, but rather only defines certain
                                    rules to abide by.</p>
                            </div>
                        </a>
                    </div>

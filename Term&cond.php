...
<div class="container py-5">
    <div class="row text-center d-flex justify-content-center">
        ...
        <div class="col-lg-10 col-md-10 col-sm-3   mt-5" style=" text-align: start;">
            ...
            <hr>
            <p>Welcome to Justice Law Firm! These terms and conditions outline the rules and regulations for the use of
                our website.</p>
            ...
            <p>The information provided on this website is for general informational purposes only and should not be
                construed as legal advice. You should consult with a qualified attorney for advice regarding your
            ...
            <p>This website may contain links to third-party websites for your convenience. We do not endorse or control
                the content of these third-party websites, and your use of them is at your own risk.</p>
            <h3 class="text-secondary mt-4">7. Modifications</h3>
            <p>[LawFirmName] reserves the right to modify these terms and conditions at any time. By continuing to use
                this website after such modifications, you agree to be bound by the revised terms.</p>

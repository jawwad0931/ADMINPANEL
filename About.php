            ...
            <div class="carousel" data-flickity='{ "groupCells": true , "autoPlay": true}' style="height:350px; width:100%">
                <div class="carousel-cell" style="height: 100%;width:550px;background:#f8f6f6;">
                    <div id="content p-2" style="height: 50%;width:80%;background:#f8f6f6;">
                        ...
                        <div>
                        <p class="text-dark">Justice Law Firm exceeded my expectations. Their professionalism and expertise brought clarity to my legal situation. With transparent communication and a dedicated approach, they secured a favorable outcome. Grateful for their exceptional service!</p>
                        </div> 
                    </div>
                </div>
                <div class="carousel-cell" style="height: 100%;width:550px;background:#f8f6f6;">
                    <div id="content p-2" style="height: 50%;width:80%;background:#f8f6f6;">
                        ...
                        <div>
                        <p class="text-dark">Incredible experience with Justice Law Firm! Their team's expertise and dedicated approach made my legal matter straightforward. Transparent communication, professionalism, and favorable outcomes — they deliver it all. Highly recommended.</p>
                        </div> 
                    </div>
                </div>
                <div class="carousel-cell" style="height: 100%;width:550px;background:#f8f6f6;">
                    <div id="content p-2" style="height: 50%;width:80%;background:#f8f6f6;">
                        ...
                        <div>
                        <p class="text-dark">Justice Law Firm proved to be the legal ally I needed. Their team's professionalism and thorough understanding of my case instilled confidence. With clear guidance and prompt communication, they navigated complexities effortlessly. Grateful for their top-notch service!</p>
                        </div> 
                    </div>
                </div>
                <div class="carousel-cell" style="height: 100%;width:550px;background:#f8f6f6;">
                    <div id="content p-2" style="height: 50%;width:80%;background:#f8f6f6;">
                        ...
                        <div>
                        <p class="text-dark">My experience with Justice Law Firm surpassed expectations. Their legal prowess, coupled with a client-centric approach, ensured a smooth journey through intricate legalities. With effective communication and a commitment to success, I found in them a reliable partner. Highly recommend their exceptional services!</p>
                        </div> 
                    </div>
                </div>
            </div>

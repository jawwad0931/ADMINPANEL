<?php include('FrontendInclude/header.php'); ?>
	...
	<div id="page">
				...
				<div class="row">
					...
					<div class="col-xs-10 text-right menu-1 main-nav">
						<ul>
							...
							<li><a href="#" data-nav-section="about">Sobre Nosotros</a></li>
							<li><a href="#" data-nav-section="practice-areas">Areas de práctica</a></li>
		...
		<section id="gtco-hero" class="gtco-cover" style="background-image: url(images/img_bg_4.jpg);"
					...
					<div class="col-md-12 col-md-offset-0 text-center">
						<div class="display-t">
							<div class="display-tc">
								<h1 class="animate-box" data-animate-effect="fadeIn">La mejor firma en la que puedes
									confiar</h1>
							</div>
						</div>
					</div>
			...
			<div class="container">
				<div class="row row-pb-md">
					<div class="col-md-8 col-md-offset-2 heading animate-box" data-animate-effect="fadeIn">
						...
						<p class="sub">Aquellos dignos de la vida más dura desean perdonar toda la fuga y acusar a otros
							de los problemas que prevén. Él la odia por cualquier dolor.</p>
						<p class="subtle-text animate-box" data-animate-effect="fadeIn">Binvenidos</p>
					</div>
				</div>
				<div class="row">
					...
					<div class="col-md-6 animate-box" data-animate-effect="fadeInLeft">
						...
						<p><a href="#" class="read-more">Saber mas <i class="icon-chevron-right"></i></a></p>
					</div>
				</div>
			</div>
		</section>
			...
			<div class="container">
				<div class="row row-pb-md">
					<div class="col-md-8 col-md-offset-2 heading animate-box" data-animate-effect="fadeIn">
						...
						<p class="sub">Aquellos dignos de la vida más dura desean perdonar toda la fuga y acusar a otros
							de los problemas que prevén. Él la odia por cualquier dolor.</p>
						<p class="subtle-text animate-box" data-animate-effect="fadeIn"><span>Areas</span> de practica
						</p>
					</div>
				</div>
				<div class="row">
			...
			<div class="container">
				...
				<div class="row team-item gtco-team-reverse">
					<div class="col-md-6 col-md-push-7 animate-box" data-animate-effect="fadeInRight">
						<div class="img-shadow">
							<img src="images/img_team_1.jpg" class="img-responsive"
								alt="Free HTML5 Bootstrap Template by FreeHTML5.co">
						</div>
					</div>
				...
				<div class="row team-item gtco-team">
					<div class="col-md-6 col-md-pull-1 animate-box" data-animate-effect="fadeInLeft">
						<div class="img-shadow">
							<img src="images/img_team_2.jpg" class="img-responsive"
								alt="Free HTML5 Bootstrap Template by FreeHTML5.co">
						</div>
					</div>
					<div class="col-md-6 animate-box" data-animate-effect="fadeInLeft">
				...
				<div class="row">
					<div class="col-md-6 col-md-push-6 animate-box">
						<form action="#">
							...
							<div class="form-group">
								...
								<textarea name="message" id="message" class="form-control" cols="30" rows="7"
					...
					<div class="col-md-4 col-md-pull-6 animate-box">
						<div class="gtco-contact-info">
							<ul>
								<li class="address">San miguel 123</li>
				...
				<div class="row copyright">
					<div class="col-md-12">
						<p class="pull-left">
							...
							<small class="block">Diseñada por Nahuel61920</small>
						</p>
						<p class="pull-right">

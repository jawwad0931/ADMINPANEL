<!-- Home page ka code yahan hai yahan testimonail aur our lawyers wala part backend se connect hai -->
<?php
...
<section id="home" class="homeintro d-flex align-items-center justify-content-center"
    style="background-image: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url(img/backgroundimg.jpg); background-size: 100% auto; background-position: center;">
...
<section class="lawyer" id="lawyer">
    <div class="container">
        ...
        <hr>
        <div class="row">
            <!-- Our Lawyer wala yahan hai ye bhi backend ka part hai -->
            <div class="container">
                <div class="row">
                    <?php
...
<!-- lawyer Testimonial ka part hai jo backend se connect hai -->
<div class="container">
...
<!-- lawyer Testimonial end -->
<!-- Our Award Slides start-->
    ...
    <div class="row">
        <div class="col-12">
            <div class="membership w-100 text-center">
                ...
                <p class="pt-2 pb-4 fw-light text-secondary">Justice law Firm Group, P.C., recognizes that family
                    law<br> matters involve complex, sensitive issues that can have a lasting<br> impact on you,
                    your family, your finances and your future.</p>
            </div>
        </div>
    </div>
    <div class="row d-flex justify-content-center">

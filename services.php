<!-- services wala page hai yahan se cards admin panel se update ho raha hai-->
<?php
...
<div class="container-fluid py-5  mb-5"
  style="background-image:url('img/servicetype.jpg');background-size:cover;height:600px;">
